                        ...
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2 ">
                                ...
                                <li class="flex">
                                    <a href="#"
                                        ...
                                        <x-responsive-nav-link :href="route('owner.penitipkambing')" :active="request()->routeIs('owner.penitipkambing')">
                                            {{ __('Penitip Kambing') }}
                                        </x-responsive-nav-link>
                                    </a>
                                </li>
                                <li class="flex">
                                    <a href="#"
                                        ...
                                        <x-responsive-nav-link :href="route('owner.listkambing')" :active="request()->routeIs('owner.listkambing')">
                                            {{ __('List Kambing') }}
                                        </x-responsive-nav-link>
                                    </a>
                                </li>
                            ...
                            <div class="space-y-2 pt-2 ">
                                <div class="pt-4 pb-1 border-t border-gray-200">
                                    ...
                                    <div class="mt-3 space-y-1">
                                        <x-responsive-nav-link :href="route('owner.profile.edit')" :active="request()->routeIs('owner.profile.edit')">
                                            <button

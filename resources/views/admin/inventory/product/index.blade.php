                    ...
                    <tbody id="tbl-body" class="divide-y divide-gray-50">
                        @forelse($products as $prod)
                            ...
                            <tr class="hover:bg-gray-50/80 transition-colors {{ $isRop ? 'bg-red-50/20' : '' }}"
                                ...
                                <td class="px-5 py-4 text-right">
                                    <a href="{{ route('admin.inventory.product.show', $prod->id) }}"
                                        class="inline-flex items-center gap-1 text-orange-600 hover:text-orange-800 font-semibold text-xs transition-colors">
                                        Detail

...
<body class="font-sans antialiased">
                            ...
                            <ul class="space-y-2 pb-2 py-2">
                                ...
                                <li class="flex">
                                    <a href="#"
                                        ...
                                        <x-responsive-nav-link :href="route('owner.penitip')" :active="request()->routeIs('owner.penitip')">
                                            {{ __('Pengguna') }}
                                        </x-responsive-nav-link>
                                    </a>
                                </li>

                                <li class="relative" x-data="{ open: {{ request()->routeIs('owner.kambing.list') || request()->routeIs('owner.domba.list') || request()->routeIs('owner.kambing.show') || request()->routeIs('owner.domba.show') || request()->routeIs('owner.kambings.update') || request()->routeIs('owner.dombas.update') ? 'true' : 'false' }} }">
                                    <!-- Main Button -->
                                    <button @click="open = !open"
                                        class="w-full text-gray-600 font-medium rounded-lg flex items-center justify-between p-2 hover:bg-gray-100 group {{ request()->routeIs('owner.kambing.list') || request()->routeIs('owner.domba.list') || request()->routeIs('owner.kambing.show') || request()->routeIs('owner.domba.show') || request()->routeIs('owner.kambings.update') || request()->routeIs('owner.dombas.update') ? 'border-l-4 border-orange-400 bg-orange-50 text-orange-700' : '' }}">
                                        <span class="flex items-center">
                                            <span
                                                class="border-l-4 border-transparent {{ request()->routeIs('owner.kambing.list') || request()->routeIs('owner.domba.list') ? 'border-indigo-400' : '' }} pr-2">
                                    ...
                                    <ul x-show="open" @click.away="open = false" x-transition x-cloak
                                        ...
                                        <li>
                                            <x-responsive-nav-link href="{{ route('owner.kambing.list') }}"
                                                class="{{ request()->routeIs('owner.kambing.list') || request()->routeIs('owner.kambing.show') || request()->routeIs('owner.kambings.update') ? 'block w-full ps-3 pe-4 py-2 border-indigo-400 text-start text-base font-medium text-orange-700 bg-orange-50 focus:outline-none focus:text-orange-800 focus:bg-orange-100 focus:border-orange-700 transition duration-150 ease-in-out' : 'block w-full ps-3 pe-4 py-2 border-transparent text-start text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out' }}"
                                                @click="if (!{{ request()->routeIs('owner.kambing.list') }}) { open = false; }">
                                                Kambing
                                            </x-responsive-nav-link>
                                        </li>
                                        <li>
                                            <x-responsive-nav-link href="{{ route('owner.domba.list') }}"
                                                class="{{ request()->routeIs('owner.domba.list') || request()->routeIs('owner.domba.show') || request()->routeIs('owner.dombas.update') ? 'block w-full ps-3 pe-4 py-2 border-indigo-400 text-start text-base font-medium text-orange-700 bg-orange-50 focus:outline-none focus:text-orange-800 focus:bg-orange-100 focus:border-orange-700 transition duration-150 ease-in-out' : 'block w-full ps-3 pe-4 py-2 border-transparent text-start text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out' }}"
                                                @click="if (!{{ request()->routeIs('owner.domba.list') || request()->routeIs('owner.domba.show') || request()->routeIs('owner.dombas.update') }}) { open = false; }">
                                                Domba
                                            </x-responsive-nav-link>
                                        </li>
                                    </ul>
                                ...
                                {{-- <li class="flex">
                                    <a href="#"
                                        ...
                                        <x-responsive-nav-link :href="route('owner.perjanjian')" :active="request()->routeIs('owner.perjanjian')">
                                            {{ __('Perjanjian') }}
                                        </x-responsive-nav-link>
                                    </a>
                                </li> --}}
  ...
  <path d="M3 4.5a.5.5 0 0 1 .5-.5h6a.5.5 0 1 1 0 1h-6a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 1 1 0 1h-6a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 1 1 0 1h-6a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5m8-6a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5"/>
                                        ...
                                        <x-responsive-nav-link :href="route('owner.penjualan')" :active="request()->routeIs('owner.penjualan')">
                                            {{ __('Penjualan') }}
                                        </x-responsive-nav-link>
                                    </a>
                                </li>
        ...
        <x-responsive-nav-link 
            ...
            {{ __('Purchase Order') }}
                            ...
                            <div class="space-y-2 pt-2 ">
                                <div class="pt-4 pb-1 border-t border-gray-200">
                                    <div class="px-4">
                                        <div class="font-medium text-base text-gray-800">{{ Auth::guard('owner')->user()->name }}
                                        </div>
                                        <div class="font-medium text-sm text-gray-500">{{ Auth::user()->email }}</div>
                                    </div>
